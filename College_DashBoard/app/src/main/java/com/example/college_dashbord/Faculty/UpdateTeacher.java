...
public class UpdateTeacher extends AppCompatActivity {
    ...
    private String downlodurl,uniqueKey,category;
    ...
    private void deleteData() {
        ...
        reference.child(category).child(uniqueKey).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP); ///back kelyavar update page var nahi yenar
